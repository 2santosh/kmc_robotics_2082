...
#define DHTPIN 7            // Digital pin 7 for DHT11
#define SOIL_PIN A1         // Soil moisture sensor on A1
#define LDR_PIN  A0         // LDR sensor on A0
#define LED_BRIGHTNESS_PIN 5
#define LED_FADE_PIN       6
#define AUDIO_PIN 9         // Audio output pin (piezo buzzer or speaker)
